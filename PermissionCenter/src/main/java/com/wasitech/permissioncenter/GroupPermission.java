...
public abstract class GroupPermission extends Permission {
    ...
    public void onResult(int requestCode) {
        ...
        switch (requestCode) {
            case Params.CAMERA_APP: {
                multiPermissionCheck(ac, AppPermission.permissionList(Params.CAMERA_APP), requestCode);
                break;
            }
            ...
            case Params.AUDIO_RECORDING_APP: {
                multiPermissionCheck(ac, AppPermission.permissionList(Params.AUDIO_RECORDING_APP), requestCode);
                break;
            }
            case Params.SMS_APP: {
                multiPermissionCheck(ac, AppPermission.permissionList(Params.SMS_APP), Params.SMS_APP);
                break;
            }
        }
    }
    ...
    public static class GroupCheck {
        ...
        public boolean camera(Context c) {
            return isPermissionSetGranted(c, GroupPermission.CODE_GROUP_CAMERA);
        }

        public boolean contact(Context c) {
            return isPermissionSetGranted(c, GroupPermission.CODE_GROUP_CONTACT);
        }

        public boolean calender(Context c) {
            return isPermissionSetGranted(c, GroupPermission.CODE_GROUP_CALENDER);
        }

        public boolean location(Context c) {
            return isPermissionSetGranted(c, GroupPermission.CODE_GROUP_LOCATION);
        }

        public boolean microphone(Context c) {
            return isPermissionSetGranted(c, GroupPermission.CODE_GROUP_MICROPHONE);
        }

        public boolean phone(Context c) {
            return isPermissionSetGranted(c, GroupPermission.CODE_GROUP_PHONE);
        }

        public boolean sms(Context c) {
            return isPermissionSetGranted(c, GroupPermission.CODE_GROUP_SMS);
        }

        public boolean storage(Context c) {
            return isPermissionSetGranted(c, GroupPermission.CODE_GROUP_STORAGE);
        }
    }
